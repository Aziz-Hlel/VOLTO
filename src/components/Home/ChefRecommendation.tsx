            ...
            <section className="bg-[#f2eee8] py-24 min-h-screen  lg:px-20 xl:px-40">
                ...
                <div className="max-w-[1200px] mx-auto px-4 flex flex-col justify-center items-center gap-6 ">
                    <div className="text-center mb-8 relative">
                        ...
                        <div className="text-[12px] uppercase tracking-[3px] text-[#C19D60] mb-2">Should to Try</div>
                        <div className="text-6xl text-[#1b1b1b] leading-none font-serif font-extralight">Chef Recommends</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                        {cheffList.map((item) => <ChefRecommendationItem props={item} />)}
                    </div>

                    <Link to={"/menu"}>
                        <Button className=' w-36 h-16 bg-[#C19D60] hover:bg-[#bd8f40] hover:cursor-pointer '> See Menu</Button>
                    </Link>
                </div>
            </section>
