    ...
    return (
        <>
            <div>
                ...
                {/* <Skiper53  /> */}
                <MenuSection img={"/img/menuWallpaper/cocktail.png"} category={drinksCategory} menuCardPostiion="right" menuTitle="VOLTO Special Cocktails" />
                <MenuSection img={"/img/menuWallpaper/banner8.inverted.jpg"} category={foodCategory} menuCardPostiion="left" menuTitle="VOLTO Drink Bar" />
                <MenuSection img={"/img/menuWallpaper/2.jpg"} category={vegansCategory} menuCardPostiion="right" menuTitle="VOLTO Food Cuisine" />
                <MenuSection img={"/img/menuWallpaper/hooka3.jpg"} category={hookahsCategory} menuCardPostiion="left" menuTitle="VOLTO Hookah" />
