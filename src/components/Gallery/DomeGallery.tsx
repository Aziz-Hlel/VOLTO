...
import { ordredTags, type IGalleryTag } from '@/types/GalleryTag';
  ...
  return (
    <>
      ...
      <div
        ...
        >
            <div className=' absolute z-20 left-0 bottom-0 flex flex-col gap-4 m-2'>
                {
                    ordredTags.map((tag) =>
                        <GalleryTags key={tag} tag={tag} onSelect={(tag) => GalleryChips.setTag(tag)} selectedTag={GalleryChips.selectedTag} />
                )}
