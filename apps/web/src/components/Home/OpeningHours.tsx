                    ...
                    <div className="md:flex md:items-center md:justify-center ">
                        ...
                        <div className="md:w-1/2 mt-12 md:mt-0 md:ml-12">
                            <div className="bg-white px-4 py-8 md:px-12 md:py-24 shadow-lg rounded w-full flex flex-col justify-center items-center ">
                                ...
                                <h4 className="text-4xl font-serif w-full  md:w-4/6 text-[#1b1b1b] mb-8 pb-5 text-center border-b border-[#C19D60]/15 ">Opening Hours</h4>

                                <div className=" flex items-start ">
                                    {/* Sunday to Tuesday */}
                                    <div className=' text-center '>
                                        <h6 className="text-sm font-semibold text-[#1b1b1b] uppercase mb-5">Sunday to Tuesday</h6>
                                    ...
                                    {/* Friday to Saturday */}
                                    <div className=' text-center '>
                                        <h6 className="text-sm font-semibold text-[#1b1b1b] uppercase mb-5">Friday to Saturday</h6>
                                        <div className=' space-y-1'>
