  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "relative z-10 h-full w-full flex   items-end",
            menuCardPostiion === "right" ? "justify-end" : " justify-start",
          )}
        >
            ...
            <div className="mx-auto flex w-full h-full flex-col items-center justify-center bg-[#777777]/25 px-4">
              <div className=" w-5/6">
                ...
                <div className="" dir="ltr">
                  ...
                  >
                    {category.subCategory.map((SubCategoryList) =>
                      chunkArray(SubCategoryList.items, 5).map((group, groupIndex) => (
                        <div key={groupIndex} className="space-y-8 select-none">
                          {" "}
                          {/* Group container */}
                            ...
                            <div key={index} className="flex gap-5 items-start">
                              ...
                              <div className="flex-1">
                                <div className="flex flex-col items-start   md:flex-row  md:justify-between md:items-center  pb-1 mb-1 gap-3">
                                  ...
                                  <span className="text-[#C19D60] text-xs md:text-base md:font-medium whitespace-nowrap">
                                    {wine.price}
                                  </span>
                                </div>
                                <p className="italic  text-sm text-[#777] text-start">
                                  {wine.description}
                                </p>
                              </div>
                            </div>
