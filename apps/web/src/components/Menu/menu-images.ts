...
export const menuImages: { [key in MenuCarouselTypes]: string[] } = {
  Food: [
    "/img/menu/cards/menu/V2.2_page-0001.jpg",
    "/img/menu/cards/menu/V2.2_page-0002.jpg",
    "/img/menu/cards/menu/V2.2_page-0003.jpg",
    "/img/menu/cards/menu/V2.2_page-0004.jpg",
    "/img/menu/cards/menu/V2.2_page-0005.jpg",
    "/img/menu/cards/menu/V2.2_page-0006.jpg",
    "/img/menu/cards/menu/V2.2_page-0007.jpg",
    "/img/menu/cards/menu/V2.2_page-0008.jpg",
  ],
  Cocktails: [
  ...
  Hookah: [
    ...
    "/img/menu/cards/hooka/V1.3_page-0002.jpg",
    "/img/menu/cards/hooka/V1.3_page-0003.jpg",
    "/img/menu/cards/hooka/V1.3_page-0004.jpg",
  ],
};
