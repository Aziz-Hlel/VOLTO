...
const Navbar = () => {
  ...
  const getNavbarClasses = () => {
    ...
    const visibilityClasses =
      isScrollingDown && scrollY > 100 ? "-translate-y-full" : "translate-y-0";
    ...
    if (scrollY === 0) {
      ...
      backgroundClasses =
        "bg-black/90 md:bg-white/90 backdrop-blur-md border-b border-gray-200/20 md:border-gray-200";
    }
  ...
  return (
    <>
            ...
            <div className="md:hidden">
              ...
              >
                ...
                <div className="w-6 h-6 relative">
                  ...
                  />
                  <span
                    className={`absolute block h-0.5 w-6 bg-current transform transition-all duration-300 ease-in-out translate-y-4 ${
                      isOpen ? "-rotate-45 -translate-y-2.5" : "translate-y-0"
                    }`}
                  />
                </div>
      ...
      >
        ...
        {/* Menu panel */}
        <div
          className={`absolute top-16 left-4 right-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200 transform transition-all duration-300 ease-out ${
            ...
            <div className="space-y-1">
              {menuItems2.map((item, index) => (
                <Link
                  key={index}
                  to={item.path}
                  className={`block px-4 py-3 rounded-xl text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 transform hover:scale-[1.02] ${
