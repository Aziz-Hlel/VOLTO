    ...
    <>
      <div className="bg-white">
        <div className="mx-auto 2xl:max-w-7xl xl:max-w-6xl lg:max-w-5xl md:max-w-3xl max-w-2xl my-20">
          <div className=" mx-auto w-fit text-5xl font-semibold md:text-6xl text-center">
            {" "}
            Meet Our Team
          </div>
          <div className="mx-auto text-center leading-relaxed w-fit text-md mt-4 mb-8">
            The team behind VOLTO brings together creative visionaries and hospitality experts
            united by a passion for elevated experiences. From bold culinary talent to immersive
            atmosphere designers, we craft a lounge and dining concept where flavor, ambiance, and
            service come together to leave a lasting impression.
          </div>
