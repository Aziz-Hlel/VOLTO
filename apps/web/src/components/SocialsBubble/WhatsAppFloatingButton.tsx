...
const WhatsAppFloatingButton = ({...props}: React.HTMLAttributes<HTMLAnchorElement>) => {
  ...
  return (
    <a
      href={"https://wa.me/+97334588466"}
      target="_blank"
      rel="noopener noreferrer"
      className=" rounded-full"
     {...props}
    >
      <div className="cursor-pointer rounded-full border p-2 bg-green-500 border-green-600 hover:bg-green-600 transition-colors duration-100">
        <svg
          className=" size-8  fill-white  rounded-full "
          viewBox="0 0 32 32"
