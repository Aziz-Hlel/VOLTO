...
const eventSeeds: IEventSeeds[] = [
  ...
  },
  {
    ...
    name: 'Hookas Night',
    description: `Hookahs Night at Volto is the perfect midweek escape where smooth flavors, chilled vibes, and great company come together. Ladies enjoy a complimentary hookah as they relax and socialize, while our resident DJ provides the perfect soundtrack for a lively yet laid-back evening. Whether you’re unwinding after work or catching up with friends, Volto’s Hookahs Night is your go-to spot to savor the night in style.`,
    startDate: null,
    endDate: null,
