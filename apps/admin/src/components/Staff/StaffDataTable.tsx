                            ...
                            {sortedData.length === 0 ? (
                                ...
                                sortedData.map((staffMember) => (
                                    <TableRow key={staffMember.id} className=' hover:cursor-default'>
                                        ...
                                        <TableCell className="text-sm">{new Date(staffMember.createdAt).toLocaleDateString()}</TableCell>
                                        <TableCell className="text-sm">{new Date(staffMember.updatedAt).toLocaleDateString()}</TableCell>
