...
const useVideoUpload = ({ videoUrlFieldName, videoKeyFieldName: imgKeyFieldName, entityType, videoPurpose, maxDuration }: IuseImageUpload) => {
    ...
    const onFileChange = async (value: File | null) => await validateVideoDuration(value) && setFile(value);
