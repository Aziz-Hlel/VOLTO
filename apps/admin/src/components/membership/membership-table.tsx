...
const MembershipActionsCell = ({ row, onEdit }: { row: { original: MembershipApplication }; onEdit: (id: string) => void }) => (
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end" className="bg-white border border-gray-200 shadow-md">
      ...
      <DropdownMenuItem className="flex items-center gap-2 text-destructive hover:bg-destructive/10 cursor-pointer">
  ...
  const columnsRows = useMemo<ColumnDef<MembershipApplication>[]>(
    () => [
      ...columnsRowsBase,
      {
        id: "actions",
        header: "Actions",
        cell: ({ row }) => <MembershipActionsCell row={row} onEdit={handleEdit} />,
        enableSorting: false,
        enableHiding: false,
      },
    ],
