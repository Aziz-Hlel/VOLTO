...
export function ChartAreaInteractive() {
  ...
  const handlePeriodChange = (value: LadiesNightStatsPeriod) => setPeriod(value as LadiesNightStatsPeriod);
    ...
    <Card className="pt-0">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>Showing total visitors for the 
            <span> {period === '90d' && 'last 3 months'} 
     ...
     { !chartData &&  <Spinner/>}
      { chartData && <ChartContainer config={chartConfig} className="aspect-auto h-[250px]  w-full">
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillparticipantWithAllRedeemedDrinks" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-participantWithAllRedeemedDrinks)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-participantWithAllRedeemedDrinks)" stopOpacity={0.1} />
              </linearGradient>
            </defs>
